...
function fetchDistanceMatrix(start, end) {
  ...
  return fetchRequestHelper(
    DISTANCE_MATRIX_API +
      `origins=${origin}&destinations=${destination}&key=${anyApiKey}` // use | pipe to pass more than one origin or destination
  );
}
...
module.exports = { fetchDirections, fetchDistanceMatrix };
